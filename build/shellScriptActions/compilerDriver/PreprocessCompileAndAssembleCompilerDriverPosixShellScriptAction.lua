...
halimede.moduleclass('PreprocessCompileAndAssembleCompilerDriverPosixShellScriptAction', AbstractPreprocessCompileAndAssembleCompilerDriverShellScriptAction)

function module:initialize(dependencies, buildVariant)
	AbstractPreprocessCompileAndAssembleCompilerDriverShellScriptAction.initialize(self, dependencies, buildVariant, UnsetEnvironmentVariablePosixShellScriptAction, ExportEnvironmentVariablePosixShellScriptAction)
end
