...
function module:_execute(shellScript, builder, compilerDriverFlags, cStandard, legacyCandCPlusPlusStringLiteralEncoding, preprocessorFlags, commandLineDefines, sources, linkerFlags, linkedLibraries, executableFilePathWithoutExtension)
